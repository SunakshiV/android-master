...
//                }
    ...
    private void setData() {
        if (checkOut != null) {
            ...
            etEnableAmount.setText("可用 " + checkOut.myCoin + com.procoin.util.CommonUtil.getOriginSymbol(symbol));
        ...
        switch (v.getId()) {
            case R.id.tvSell:
                ...
                if (TextUtils.isEmpty(price)) {
                    com.procoin.util.CommonUtil.showmessage("请输入卖出价格", getActivity());
                    return;
                }
                if (TextUtils.isEmpty(amount)) {
                    com.procoin.util.CommonUtil.showmessage("请输入卖出数量", getActivity());
                    return;
                }
...
//                        return;
//                    }
//                String tips = "您将以" + price + com.procoin.util.CommonUtil.getUnitSymbol(symbol) + "价格委托卖出" + amount + com.procoin.util.CommonUtil.getOriginSymbol(symbol);
                String tips = "是否确定下单？";
    ...
    private void showSubmitTipsDialog(String tips, final String moneyOrAmount, final String price, final String balance) {
        ...
        submitTipsDialog.setTvTitle("卖出概要");
